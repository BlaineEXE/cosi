...
func TestS3BucketInfoTranslator_RoundTrips(t *testing.T) {
	...
	tests := []struct {
		name    string
		vars    map[cosiapi.S3BucketInfoVar]string // input
		wantRpc *cosiproto.S3BucketInfo
	}{
		{"nil info", nil, nil},
		{"empty info", map[cosiapi.S3BucketInfoVar]string{}, nil},
		{"info all set", map[cosiapi.S3BucketInfoVar]string{
		...
		{"addressing style unset",
			map[cosiapi.S3BucketInfoVar]string{
...
func TestS3BucketInfoTranslator_RpcToApi(t *testing.T) {
	...
	tests := []struct {
		...
		wantApi map[cosiapi.S3BucketInfoVar]string
	}{
		{"nil input", nil, nil},
		{"empty input", nil, nil},
